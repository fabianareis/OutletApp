...
export default function Profile({navigation}) {
    ...
    return (
        ...
        <Text style={styles.tituloH1}>Atualizar Cadastro:</Text>
        <Text  style={styles.tituloH3}>A atualização correta dos dados é importante para que seus pedidos sejam entregues corretamente.</Text>
